...
class MainFrame(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.parent.title('VisualServer 0.7')
        ...
        tk.Label(text='Server is up!', fg='green', font=('', 12, '')).pack(side=tk.TOP, pady=(5, 0))
        tk.Label(text='Up-Time', font=('', 10, '')).pack(side=tk.LEFT, padx=(5, 0))

        self.uptime_value = tk.StringVar()
        self.uptime_label = tk.Label(textvariable=self.uptime_value, fg='blue', font=('', 10, ''))
